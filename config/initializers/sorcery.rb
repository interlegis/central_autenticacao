...
Rails.application.config.sorcery.configure do |config|
  ...
  config.facebook.callback_url = ENV['CENTRAL_AUTENTICACAO_URL'].present? ? ENV['CENTRAL_AUTENTICACAO_URL'] : "http://localhost:10524/oauth/callback?provider=facebook"
  ...
  config.google.callback_url = ENV['CENTRAL_AUTENTICACAO_URL'].present? ? "https://" + ENV['CENTRAL_AUTENTICACAO_URL'] + "/oauth/callback?provider=google" : "http://localhost:10524/oauth/callback?provider=google"
